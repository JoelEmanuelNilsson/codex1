...
- repo-local lane skills for TDD, diagnosis, architecture improvement, and prototyping
...
Setup is local to the target repository. It does not install global hooks, global skills, project hooks, custom continuation adapters, continuation policy, or native goal integrations.
